...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObject : MonoBehaviour
    {
        ...
        private void EnsureVolumeContainerRef()
        {
            ...
            {
                // Navian: silenced the "VolumeContainer missing" warning. It is a false alarm
                // during construction (VolumeObjectFactory sets volumeContainerObject right
                // after AddComponent, so Awake/OnValidate run while it is still null). The
                // recovery logic below is kept.
